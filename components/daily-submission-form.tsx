...
import { CheckCircle, XCircle, Clock, Save, X } from "lucide-react"
...
export function DailySubmissionForm({ existingSubmission, onClose, onSuccess }: DailySubmissionFormProps) {
  ...
  const handlePrayerChange = (prayer: keyof PrayerStatus, status: "completed" | "missed" | "masbuq") => {
              ...
              {Object.entries(prayerNames).map(([prayer, name]) => (
                <div key={prayer} className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) =>
                      handlePrayerChange(prayer as keyof PrayerStatus, value as "completed" | "missed" | "masbuq")
                    }
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="missed" id={`${prayer}-missed`} />
                      <Label htmlFor={`${prayer}-missed`} className="flex items-center gap-1 text-red-600">
